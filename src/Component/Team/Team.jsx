...
const Team = () => {
  return (
    <div className=" px-auto  bg-gray-800 md:px-8">
      <div className="mb-10 md:mb-16">
        <h2 className="text-2xl font-bold text-gray-400 text-center mb-4">Our Hair Specialists</h2>

        <p className="max-w-screen-md mx-auto text-center text-gray-300 md:text-lg">
