                        ...
                        <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-gray-300 border-0">
                            <div className="rounded-t mb-0 px-6 py-6">
                                ...
                                <div className="btn-wrapper text-center">
                                    ...
                                    <button className="bg-white active:bg-gray-100 text-gray-800 font-normal px-4 py-2 rounded outline-none focus:outline-none mr-1 mb-1 uppercase shadow hover:shadow-md inline-flex items-center  text-xs" type="button" style={{transition: "all 0.15s ease 0s"}}><img alt="..." className="w-5 mr-1" src="images/icons-google.svg" onClick={hundleGoogle}/>Google</button>
                                </div>
